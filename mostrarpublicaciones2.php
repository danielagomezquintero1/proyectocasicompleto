...
<table style="background-color: white;">
	<tr> 
		...
		<td><div class="col-12 mb-4" style="font-weight:bold">PUBLICACIÓN</div></td>		
...
<tr>
	...
	$sqlp = "SELECT user, ruta FROM archivos
WHERE user=1
UNION ALL
SELECT user, descripcion FROM publicaciones
WHERE user=1;";
	...
	while($data=$resultp->fetch_assoc()){
		...
		<td><a data-toggle='modal' data-target='#modalEdicion' onclick="agregaform('<?php echo $datos?>')" class='btn btn-primary'> <img id='editar' src='editaricon.png'> Modificar</a>
			<?php echo"<a href='eliminar_user.php?id='1' class='btn btn-danger'><img id='eliminar' src='eliminar.png'> Eliminar </a>
			</td>
			</tr>";}?>
