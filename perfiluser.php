                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#"> |
                      ...
                      $sql2 =$mysqli->query("SELECT * FROM publicaciones WHERE user='".$rowA['id']."'");
      ...
      <div class="row mt-5">
        <div class="col-12 p-3 m-2" style="background-color: white;">
          ...
          while($publicaciones = $sql2->fetch_array()) {
            ...
            <img class="m-3 view_data"name="view" value="view" id="<?php echo $publicaciones['id']; ?>" data-target="#<?php echo $publicaciones['id']; ?>" data-toggle="modal" style="width:29%"src='<?php echo $publicaciones['descripcion']; ?>');>
